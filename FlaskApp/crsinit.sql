...
DROP PROCEDURE IF EXISTS add_admin_account CASCADE;
DROP PROCEDURE IF EXISTS add_enrollment CASCADE;
DROP PROCEDURE IF EXISTS add_student_account CASCADE;
DROP PROCEDURE IF EXISTS add_teacher_account CASCADE;
DROP PROCEDURE IF EXISTS switch_to_new_semester CASCADE;
DROP FUNCTION IF EXISTS process_bypass_result CASCADE;
DROP FUNCTION IF EXISTS process_enrollment_entry CASCADE;
